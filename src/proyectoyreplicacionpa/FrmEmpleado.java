...
private void nuevo(){
    ...
    try {
        ...
        EmpleadoBeans Ca=new EmpleadoBeans();
        String query = "UPDATE Empleado SET Nombre=?, Apellido=?, Cargo=?, Sueldo=? WHERE ID_empleado=?";
        ...
        pstmt.setString(4, txtSueldo.getText());
        pstmt.setInt(5, (int) jTEmpleado.getValueAt(jTEmpleado.getSelectedRow(), 0));
    ...
    ConexionDB conexionDB = new ConexionDB("localhost", "root", "root", "Cafeteria");
    String query="delete from Empleado  "+ "where ID_empleado='"+jTEmpleado.getValueAt(jTEmpleado.getSelectedRow(),0)+"';";
    try {
        conexionDB.ConectarDB();
        PreparedStatement pstmt = conexionDB.getConexion().prepareStatement(query);
        txtNombre.setText("");
