...
public class FrmProducto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblID_Producto.setForeground(new java.awt.Color(158, 111, 121));
        ...
        lblCedula.setForeground(new java.awt.Color(158, 111, 121));
        ...
        lblApellido.setForeground(new java.awt.Color(158, 111, 121));
        ...
        getContentPane().add(btnMostrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 170, 93, -1));
        ...
        lblTelefono1.setForeground(new java.awt.Color(158, 111, 121));
        ...
        lblObservacion.setForeground(new java.awt.Color(158, 111, 121));
        ...
        getContentPane().add(lblFondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, -10, 580, 460));
...
public void Actualizar() {
    ...
    try {
        ...
        ProductoBeans Pr=new ProductoBeans();
        String query = "UPDATE Producto SET Producto=?, Precio=?, Cantidad=?, Caducidad=?, Proveedor=? WHERE ID_Producto=?";
        PreparedStatement pstmt = conexionDB.getConexion().prepareStatement(query);
        pstmt.setString(1, txtProducto.getText());
        pstmt.setString(2, txtPrecio.getText());
        pstmt.setString(3, txtCantidad.getText());
        pstmt.setString(4, txtCaducidad.getText());
        pstmt.setString(5, txtProveedor.getText());
        pstmt.setInt(6, (int) jTProducto.getValueAt(jTProducto.getSelectedRow(), 0));
    ...
    ConexionDB conexionDB = new ConexionDB("localhost", "root", "root", "Cafeteria");
    String query="delete from Producto  "+ "where ID_Producto='"+jTProducto.getValueAt(jTProducto.getSelectedRow(),0)+"';";
    try {
        conexionDB.ConectarDB();
        PreparedStatement pstmt = conexionDB.getConexion().prepareStatement(query);
        txtProducto.setText("");
